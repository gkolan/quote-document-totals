...
- **Not measured:** the 200 lines x 60 buckets governor-limit run in §5. The 36-line x 36-bucket case in the test class passes comfortably; the documented ceiling remains unverified and must not be quoted as if it were.
