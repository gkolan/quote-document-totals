...
- **Test evidence:** `QuoteDocumentPresentationTest`, 5/5. Full suite: 146 ran, 141 passed, 5 failed; the same 5 pre-existing org-only failures noted in [step 01A](step-01a-extension-contracts.md) §11 remain and are unrelated.
